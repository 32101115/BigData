...
data_parent = pd.read_csv('Data/Output/training_data.csv')
...
pickle.dump(cv_xgb_model, open("ModelFiles/xgboost.dat", "wb"))
...
pickle.dump(cv_svm_model, open("ModelFiles/svm.dat", "wb"))
...
pickle.dump(cv_lr_model, open("ModelFiles/lr.dat", "wb"))
...
pickle.dump(cv_rf_model, open("ModelFiles/randomforest.dat", "wb"))
